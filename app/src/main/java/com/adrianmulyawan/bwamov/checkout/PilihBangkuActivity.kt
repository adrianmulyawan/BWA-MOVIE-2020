...
class PilihBangkuActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // setelah dilempar bise digunakan di activity ini
        val data = intent.getParcelableExtra<Film>("data")

        // salah satu nya menampilkan judul pada saat memilih bangku
        ...
        a3.setOnClickListener {
            if (statusA3) {
                ...
                // digunakan untuk mengisikan data biar di page sebelah ini kita bisa lihat
                // pada page setelah ini kita bisa lihat item setelah ini karna selalu berubah - ubah
        ...
        btn_home.setOnClickListener {
            // dikirimkan dengan menggunakan intent dengan menggunakan dataList
            val intent = Intent(
                this,
    ...
    // Digunakan untuk menampilkan teks dan mengubah teksnya
